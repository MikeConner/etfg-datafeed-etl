...
class BarclaysLetnsEodTransformer
  ...
  def process(row)
    new_row = {
      ...
      rebalancing_trigger_level: row['Rebalancing Trigger Level'],
      termination_trigger_level: row['Termination Trigger Level'],
      index_roll_cost: row['Index Roll Cost'],
      monthly_factor: row['Monthly Factor'],
